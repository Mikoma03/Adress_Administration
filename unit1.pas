...
begin
  try
  listbox1.items.loadfromfile('C:\Users\Public\Documents\SaveDate1.txt');
  listbox2.items.loadfromfile('C:\Users\Public\Documents\SaveDate2.txt');
  listbox3.items.loadfromfile('C:\Users\Public\Documents\SaveDate3.txt');
  listbox4.items.loadfromfile('C:\Users\Public\Documents\SaveDate4.txt');
  listbox5.items.loadfromfile('C:\Users\Public\Documents\SaveDate5.txt');
  finally
